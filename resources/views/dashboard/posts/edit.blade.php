...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="mb-3">
                    <label for="image" class="form-label">upload gambar</label><input type="hidden" name="oldImage"
                        value="{{ $post->image }}">
                    @if ($post->image)
            ...
            <button type="submit" class="btn btn-primary"><span data-feather="save"></span> Update Postingan</button>
        </form>
