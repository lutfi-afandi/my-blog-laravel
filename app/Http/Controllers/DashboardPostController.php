...
class DashboardPostController extends Controller
{
    ...
    {
        return view('dashboard.posts.create', ['title' => 'Buat Postingan', 'categories' => Category::all()]);
    }
    ...
    {
        return view('dashboard.posts.edit', ['title' => 'Edit Postingan', 'post' => $post, 'categories' => Category::all()]);
    }
